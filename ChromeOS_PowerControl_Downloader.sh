...
echo "         ${RED}████████████████████${RESET}         "
echo "       ${RED}████████████████████████${RESET}       "
echo "     ${GREEN}████████${RED}████████████${GREEN}████████${RESET}     "
echo "   ${GREEN}████████${RED}██████${BLUE}██████${RED}██████${GREEN}████████${RESET}   "
echo "  ${GREEN}████████${RED}████${BLUE}████████${BLUE}████${RED}████${GREEN}████████${RESET}  "
echo "  ${YELLOW}████████${GREEN}████${BLUE}████████${BLUE}████${GREEN}████${YELLOW}████████${RESET}  "
echo "   ${YELLOW}████████${GREEN}██████${BLUE}██████${GREEN}██████${YELLOW}████████${RESET}   "
echo "     ${YELLOW}████████${GREEN}████████████${YELLOW}████████${RESET}     "
echo "       ${YELLOW}████████████████████${RESET}       "
echo "         ${YELLOW}████████████████${RESET}         "
echo "             ${YELLOW}████████████${RESET}             "
echo ""
